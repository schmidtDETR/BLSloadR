...
For example:
- Complete CES download: 60+ seconds for ~5.6M rows
- Single state (MA): ~3.5 seconds for ~210K rows
- Seasonally adjusted national: ~3.7 seconds for ~392K rows
